...
class zRoot(parameter):
    '''
    The z position of the root leading edge of the strut.
    ...
    def calc(self):
        '''
        Calculates the z location of the strut root leading edge according to the
        fuselage geometry.
        ...
        the lowermost position of the fuselage.
        '''
