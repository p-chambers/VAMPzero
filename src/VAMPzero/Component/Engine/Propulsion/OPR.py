...
class OPR(parameter):
    ...
    def __init__(self, value=0., unit='', parent='', cpacsPath=''):
        super(OPR, self).__init__(value=value, unit=unit, doc=self.__doc__, status='init', parent=parent,
                                  cpacsPath=cpacsPath)

    def calc(self):
        '''
        Set the value for the OPR to 27.3
