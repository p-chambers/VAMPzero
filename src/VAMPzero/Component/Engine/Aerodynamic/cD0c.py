...
class cD0c(parameter):
    '''
    Component zero lift drag coefficient of all engines
    ...
    def calc(self):
        '''
        Calculates the zero lift drag coefficient from the wetted area of all engines and the friction coefficients 
        ...
        return self.setValueCalc((nLam * cfLAM + (1 - nLam) * cfTURB) * formFactor * wetArea * q)
        ###################################################################################################
