...
class cTip(parameter):
    '''
    Calculates the tip chord of the aileron (note: only one aileron is considered).
    ...
    def calc(self):
        ...
        cRootAileron = self.parent.cRoot.getValue()

        cTipAileron = taperRatioAileron * cRootAileron

        return self.setValueCalc(cTipAileron)
