...
class avgChord(parameter):
    '''
    Calculates the average chord of the total reference area. 
    ...
    def calc(self):
        ...
        * spanWing 34.1 - 79.80 m 
        ...
        avgChordLED = 0.171774319 + 0.00424715964 * refAreaWing - 0.0024290817 * spanWing - 0.00003584083723 * refAreaWing * spanWing

        return self.setValueCalc(avgChordLED)
