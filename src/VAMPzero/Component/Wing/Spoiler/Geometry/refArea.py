...
class refArea(parameter):
    '''
    Calculates the total reference area of all spoilers, one half of the wing.
    ...
    def calc(self):
        ...
        * spanWing 34.1 - 79.80 m 
        ...
        refAreaSPO = -53.38480213 + 2.85255112 * spanWing + 0.00007804017479 * refAreaWing * refAreaWing + -0.03023792999 * spanWing * spanWing

        return self.setValueCalc((refAreaSPO / 2.))
