...
class refArea(parameter):
    '''
    Calculates the total reference area of all flaps, one half of the wing.
    ...
    def calc(self):
        ...
        * spanWing 34.1 - 79.80 m 
        ...
        refAreaFLAP = 0.4469510166 * spanWing + 0.08452485413 * refAreaWing - 4.486871837

        return self.setValueCalc((refAreaFLAP / 2.))
