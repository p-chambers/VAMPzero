...
class sigmaAP(parameter):
    '''
    sigma at Airport height 
    '''

    def __init__(self, value=0., unit='m/s', parent='', cpacsPath=''):
        super(sigmaAP, self).__init__(value=value, unit=unit, doc=self.__doc__, status='init', parent=parent,
                                      cpacsPath=cpacsPath)
    ...
    def calc(self):
        ...
        return self.setValueCalc(rhoAP / rhoA[0])
