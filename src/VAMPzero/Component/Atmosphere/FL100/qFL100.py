...
class qFL100(parameter):
    '''
    q at FL100 
    '''

    def __init__(self, value=0., unit='N', parent='', cpacsPath=''):
        super(qFL100, self).__init__(value=value, unit=unit, doc=self.__doc__, status='init', parent=parent,
                                     cpacsPath=cpacsPath)
    ...
    def calc(self):
        ...
        return self.setValueCalc(0.5 * rhoFL100 * TASFL100 ** 2)
        ###################################################################################################
