...
class sigmaFL100(parameter):
    '''
    sigma at FL100 
    '''

    def __init__(self, value=0., unit='m/s', parent='', cpacsPath=''):
        super(sigmaFL100, self).__init__(value=value, unit=unit, doc=self.__doc__, status='init', parent=parent,
                                         cpacsPath=cpacsPath)
    ...
    def calc(self):
        ...
        return self.setValueCalc(rhoFL100 / rhoA[0])
