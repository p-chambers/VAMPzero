...
class cRoot(parameter):
    ...
    def calc(self):
        '''
        Calculates the root chord of the horizontal tail depending on the location value.
    ...
    def calcTtail(self):
        '''
        Calculates the root chord according to the cTip of VTP

        '''
        cTipVTP = self.parent.aircraft.vtp.cTip.getValue()

        return self.setValueCalc(cTipVTP)
