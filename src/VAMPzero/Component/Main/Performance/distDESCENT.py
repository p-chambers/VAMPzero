...
class distDESCENT(parameter):
    ...
    def __init__(self, value=0., unit='m', parent='', cpacsPath=''):
        super(distDESCENT, self).__init__(value=value, unit=unit, doc=self.__doc__, status='init', parent=parent,
                                          cpacsPath=cpacsPath)

    def calc(self):
        '''
        Calculates the distance for the descent segment
        ...
        time = self.parent.timeDESCENT.getValue()
