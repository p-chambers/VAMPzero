...
class loDTO(parameter):
    '''
    The lift over drag ratio for take-off
    ...
    def __init__(self, value=0., unit='', parent='', cpacsPath=''):
        super(loDTO, self).__init__(value=value, unit=unit, doc=self.__doc__, status='init', parent=parent,
                                    cpacsPath=cpacsPath)
