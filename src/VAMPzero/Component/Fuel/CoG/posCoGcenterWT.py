...
class posCoGcenterWT(parameter):
    '''
    X Position of the center of gravity of the center wing tank
	
    :Unit: [m]
    '''

    def __init__(self, value=0., unit='m', parent='', cpacsPath=''):
        super(posCoGcenterWT, self).__init__(value=value, unit=unit, doc=self.__doc__, status='init', parent=parent,
                                     cpacsPath=cpacsPath)

    def calc(self):
        '''
        Calculates the posCoG of the center wing tank.
